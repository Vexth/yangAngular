...
import { M1v1openComponent } from './m1v1open/m1v1open.component';
...
export class M1v1Component implements OnInit{
  ...
  pageNews:number[] = [];
  @ViewChild('m1v1open') public m1v1open:M1v1openComponent;
  ...
  addnew(): void {
    this.m1v1open.showChildModal(null);
  }
  ...
  public edit(): void {
    ...
    switch(typeid){
      ...
      break;
      case 1:
        this.m1v1open.showChildModal(flex[0].dataItem);
      break;
    }
  }
  ...
  onRenovate(itme){
    ...
    this.GetList.GetAuthlist().then(res => {
      if (res.code === 0) {
        this.GetList.GetListPageBy_M1V1(itme).then(res => this.cvPaging.sourceCollection = res)
      }
    });
  }
}
